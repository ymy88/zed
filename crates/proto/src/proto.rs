...
messages!(
    ...
    (GitBranchLog, Foreground),
    (GitBranchLogResponse, Foreground),
    (GitDiffNameStatus, Foreground),
    (GitDiffNameStatusResponse, Foreground),
    (GitDiffFileText, Foreground),
    (GitDiffFileTextResponse, Foreground),
...
request_messages!(
    ...
    (LeaveRoom, Ack),
    (GitBranchLog, GitBranchLogResponse),
    (GitDiffNameStatus, GitDiffNameStatusResponse),
    (GitDiffFileText, GitDiffFileTextResponse),
